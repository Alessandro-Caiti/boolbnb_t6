...
<head>
    ...
    <body>
        ...
        <main>
            ...
            <div class="container my-main-stat-container">
                <div class="my-mid-container">
                    <div class="my-stat-container">
                        <canvas id="myChart" width="400" height="400"></canvas>
                    </div>
                    <div class="my-stat-button-container">
                        <a class="btn btn-primary" href="{{route('user.places.index')}}">Torna alla Dashboard</a>
                    </div>
                </div>
            </div>
        </main>
